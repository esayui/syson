 ...
 */
@Service
public class DodafOperationalNodeStyleDeserializer implements ICustomNodeStyleDeserializer {

    @Override
    public boolean canHandle(String type) {
        return type.equals(DodafOperationalNodeStyleProvider.NODE_SYSML_IMPORTED_PACKAGE);
    }

    @Override
    public INodeStyle handle(ObjectNode root, JsonParser jsonParser, DeserializationContext context) throws JacksonException {
        return context.readTreeAsValue(root, DodafOperationalNodeStyle.class);
    }
}
