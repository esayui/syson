...
import org.eclipse.syson.application.nodes.DodafOperationalNodeStyle;
 ...
 */
@Service
public class DodafOperationalNodeAppearanceHandler implements INodeAppearanceHandler {
    ...
    public boolean canHandle(INodeStyle nodeStyle) {
        return nodeStyle instanceof DodafOperationalNodeStyle;
    }
    ...
    public NodeAppearance handle(INodeStyle providedStyle, List<INodeAppearanceChange> changes, Optional<NodeAppearance> previousNodeAppearance) {
        ...
        if (providedStyle instanceof DodafOperationalNodeStyle providedDodafOperationalNodeStyle) {
            DodafOperationalNodeStyle.Builder styleBuilder = DodafOperationalNodeStyle.newDodafOperationalNodeStyle(providedDodafOperationalNodeStyle);
    ...
    private void handleBackground(DodafOperationalNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
        ...
        if (!this.handleResetChange(BACKGROUND, changes, customizedStyleProperties)) {
            ...
            if (optionalBackgroundChange.isPresent()) {
                ...
                customizedStyleProperties.add(BACKGROUND);
                    ...
                    && optionalPreviousNodeStyle.get() instanceof DodafOperationalNodeStyle previousNodeStyle) {
    ...
    private void handleBorderColor(DodafOperationalNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
    ...
    private void handleBorderSize(DodafOperationalNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
    ...
    private void handleBorderStyle(DodafOperationalNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
            Set<String> customizedStyleProperties) {
