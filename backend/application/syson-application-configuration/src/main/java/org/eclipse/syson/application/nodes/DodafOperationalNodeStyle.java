 ...
 */
@Immutable
public final class DodafOperationalNodeStyle implements INodeStyle {
    ...
    private DodafOperationalNodeStyle() {
        // Prevent instantiation
    }

    public static Builder newDodafOperationalNodeStyle() {
        return new Builder();
    }

    public static Builder newDodafOperationalNodeStyle(DodafOperationalNodeStyle nodeStyle) {
    ...
    public static final class Builder {
        ...
        private Builder(DodafOperationalNodeStyle nodeStyle) {
        ...
        public DodafOperationalNodeStyle build() {
            DodafOperationalNodeStyle nodeStyleDescription = new DodafOperationalNodeStyle();
