...
import { DodafCapabilityPartProps } from './DodafCapabilityPart.types';
import { useUpdateDodafCapabilityAppearance } from './useUpdateDodafCapabilityAppearance';
import { GQLDodafCapabilityAppearanceInput } from './useUpdateDodafCapabilityAppearance.types';
...
export const DodafCapabilityPart = ({
  nodeIds,
  style,
  customizedStyleProperties,
}: DodafCapabilityPartProps) => {
  const { editingContextId, diagramId } = useContext<DiagramContextValue>(DiagramContext);
  const { updateDodafCapabilityAppearance } = useUpdateDodafCapabilityAppearance();
  ...
  const handleEditProperty = (newValue: Partial<GQLDodafCapabilityAppearanceInput>) =>
    updateDodafCapabilityAppearance(editingContextId, diagramId, nodeIds, newValue);
