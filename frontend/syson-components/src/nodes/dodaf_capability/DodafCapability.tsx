...
import { NodeComponentsMap, DodafCapabilityData } from './DodafCapability.types';

const dodafCapabilitynodeStyle = (
  theme: Theme,
...
export const DodafCapability: NodeComponentsMap['dodafCapability'] = memo(
  ({ data, id, selected, dragging }: NodeProps<Node<DodafCapabilityData>>) => {
    ...
    return (
      <>
        ...
        <div
          style={{
            ...dodafCapabilitynodeStyle(theme, data.style, !!selected, data.isHovered, data.faded),
          }}
