...
import { GQLDodafCapabilityStyle } from './DodafCapability.types';
import { DodafCapabilityPart } from './DodafCapabilityPart';

export const DodafCapabilityPaletteAppearanceSection = ({
  diagramElementIds,
}: PaletteAppearanceSectionContributionComponentProps) => {
  ...
  return (
    <>
      <DodafCapabilityPart
        ...
        style={data.nodeAppearanceData.gqlStyle as GQLDodafCapabilityStyle}
