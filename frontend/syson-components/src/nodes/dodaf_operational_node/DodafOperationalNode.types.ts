...
export interface DodafOperationalNodeData extends NodeData {}

export interface GQLDodafOperationalNodeStyle extends GQLNodeStyle {
  background: string;
  borderColor: string;
  borderStyle: string;
  borderSize: number;
...
export interface NodeDataMap {
  dodafOperationalNode: DodafOperationalNodeData;
}
