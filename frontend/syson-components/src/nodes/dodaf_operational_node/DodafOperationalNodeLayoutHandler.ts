...
import { DodafOperationalNodeData } from './DodafOperationalNode.types';

const rectangularNodePadding: number = 8;

export class DodafOperationalNodeLayoutHandler implements INodeLayoutHandler<DodafOperationalNodeData> {
  public canHandle(node: Node<NodeData, DiagramNodeType>): boolean {
    return node.type === 'dodafOperationalNode';
  }
