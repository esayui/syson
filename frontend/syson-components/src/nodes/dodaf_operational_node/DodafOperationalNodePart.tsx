...
import { DodafOperationalNodePartProps } from './DodafOperationalNodePart.types';
import { useUpdateDodafOperationalNodeAppearance } from './useUpdateDodafOperationalNodeAppearance';
import { GQLDodafOperationalNodeAppearanceInput } from './useUpdateDodafOperationalNodeAppearance.types';
...
export const DodafOperationalNodePart = ({
  nodeIds,
  style,
  customizedStyleProperties,
}: DodafOperationalNodePartProps) => {
  const { editingContextId, diagramId } = useContext<DiagramContextValue>(DiagramContext);
  const { updateDodafOperationalNodeAppearance } = useUpdateDodafOperationalNodeAppearance();
  ...
  const handleEditProperty = (newValue: Partial<GQLDodafOperationalNodeAppearanceInput>) =>
    updateDodafOperationalNodeAppearance(editingContextId, diagramId, nodeIds, newValue);
