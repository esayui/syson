...
import { GQLDodafOperationalNodeStyle } from './DodafOperationalNode.types';
import { DodafOperationalNodePart } from './DodafOperationalNodePart';

export const DodafOperationalNodePaletteAppearanceSection = ({
  diagramElementIds,
}: PaletteAppearanceSectionContributionComponentProps) => {
  ...
  return (
    <>
      <DodafOperationalNodePart
        nodeIds={diagramElementIds}
        style={data.nodeAppearanceData.gqlStyle as GQLDodafOperationalNodeStyle}
