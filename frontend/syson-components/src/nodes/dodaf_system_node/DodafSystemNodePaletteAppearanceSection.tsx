...
import { GQLDodafSystemNodeStyle } from './DodafSystemNode.types';
import { DodafSystemNodePart } from './DodafSystemNodePart';

export const DodafSystemNodePaletteAppearanceSection = ({
  diagramElementIds,
}: PaletteAppearanceSectionContributionComponentProps) => {
  ...
  return (
    <>
      <DodafSystemNodePart
        ...
        style={data.nodeAppearanceData.gqlStyle as GQLDodafSystemNodeStyle}
