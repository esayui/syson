...
import { NodeComponentsMap, DodafSystemNodeData } from './DodafSystemNode.types';

const dodafSystemNodenodeStyle = (
  theme: Theme,
...
export const DodafSystemNode: NodeComponentsMap['dodafSystemNode'] = memo(
  ({ data, id, selected, dragging }: NodeProps<Node<DodafSystemNodeData>>) => {
    ...
    return (
      <>
        ...
        <div
          style={{
            ...dodafSystemNodenodeStyle(theme, data.style, !!selected, data.isHovered, data.faded),
          }}
