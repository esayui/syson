...
import { DodafSystemNodePartProps } from './DodafSystemNodePart.types';
import { useUpdateDodafSystemNodeAppearance } from './useUpdateDodafSystemNodeAppearance';
import { GQLDodafSystemNodeAppearanceInput } from './useUpdateDodafSystemNodeAppearance.types';
...
export const DodafSystemNodePart = ({
  nodeIds,
  style,
  customizedStyleProperties,
}: DodafSystemNodePartProps) => {
  const { editingContextId, diagramId } = useContext<DiagramContextValue>(DiagramContext);
  const { updateDodafSystemNodeAppearance } = useUpdateDodafSystemNodeAppearance();
  ...
  const handleEditProperty = (newValue: Partial<GQLDodafSystemNodeAppearanceInput>) =>
    updateDodafSystemNodeAppearance(editingContextId, diagramId, nodeIds, newValue);
