...
export const DodafInformationExchange: NodeComponentsMap['dodafInformationExchange'] = memo(
  ({ data, id, selected, dragging }: NodeProps<Node<DodafInformationExchangeData>>) => {
