...
export interface DodafInformationExchangeData extends NodeData {}

export interface GQLDodafInformationExchangeStyle extends GQLNodeStyle {
  background: string;
  borderColor: string;
  borderStyle: string;
  borderSize: number;
...
export interface NodeDataMap {
  dodafInformationExchange: DodafInformationExchangeData;
}
