...
import { DodafInformationExchangePartProps } from './DodafInformationExchangePart.types';
import { useUpdateDodafInformationExchangeAppearance } from './useUpdateDodafInformationExchangeAppearance';
import { GQLDodafInformationExchangeAppearanceInput } from './useUpdateDodafInformationExchangeAppearance.types';
...
export const DodafInformationExchangePart = ({
  nodeIds,
  style,
  customizedStyleProperties,
}: DodafInformationExchangePartProps) => {
  const { editingContextId, diagramId } = useContext<DiagramContextValue>(DiagramContext);
  const { updateDodafInformationExchangeAppearance } = useUpdateDodafInformationExchangeAppearance();
  ...
  const handleEditProperty = (newValue: Partial<GQLDodafInformationExchangeAppearanceInput>) =>
    updateDodafInformationExchangeAppearance(editingContextId, diagramId, nodeIds, newValue);
