...
import { GQLDodafInformationExchangeStyle } from './DodafInformationExchange.types';
import { DodafInformationExchangePart } from './DodafInformationExchangePart';

export const DodafInformationExchangePaletteAppearanceSection = ({
  diagramElementIds,
}: PaletteAppearanceSectionContributionComponentProps) => {
  ...
  return (
    <>
      <DodafInformationExchangePart
        nodeIds={diagramElementIds}
        style={data.nodeAppearanceData.gqlStyle as GQLDodafInformationExchangeStyle}
