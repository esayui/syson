...
export interface DodafOrganizationData extends NodeData {}

export interface GQLDodafOrganizationStyle extends GQLNodeStyle {
  background: string;
  borderColor: string;
  borderStyle: string;
  borderSize: number;
...
export interface NodeDataMap {
  dodafOrganization: DodafOrganizationData;
}
