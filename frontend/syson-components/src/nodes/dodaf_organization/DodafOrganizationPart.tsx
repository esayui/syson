...
import { DodafOrganizationPartProps } from './DodafOrganizationPart.types';
import { useUpdateDodafOrganizationAppearance } from './useUpdateDodafOrganizationAppearance';
import { GQLDodafOrganizationAppearanceInput } from './useUpdateDodafOrganizationAppearance.types';
...
export const DodafOrganizationPart = ({
  nodeIds,
  style,
  customizedStyleProperties,
}: DodafOrganizationPartProps) => {
  const { editingContextId, diagramId } = useContext<DiagramContextValue>(DiagramContext);
  const { updateDodafOrganizationAppearance } = useUpdateDodafOrganizationAppearance();
  ...
  const handleEditProperty = (newValue: Partial<GQLDodafOrganizationAppearanceInput>) =>
    updateDodafOrganizationAppearance(editingContextId, diagramId, nodeIds, newValue);
