...
import { GQLDodafOrganizationStyle } from './DodafOrganization.types';
import { DodafOrganizationPart } from './DodafOrganizationPart';

export const DodafOrganizationPaletteAppearanceSection = ({
  diagramElementIds,
}: PaletteAppearanceSectionContributionComponentProps) => {
  ...
  return (
    <>
      <DodafOrganizationPart
        nodeIds={diagramElementIds}
        style={data.nodeAppearanceData.gqlStyle as GQLDodafOrganizationStyle}
