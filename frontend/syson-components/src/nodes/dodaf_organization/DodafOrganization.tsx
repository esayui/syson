...
import { NodeComponentsMap, DodafOrganizationData } from './DodafOrganization.types';

const dodafOrganizationnodeStyle = (
  theme: Theme,
...
export const DodafOrganization: NodeComponentsMap['dodafOrganization'] = memo(
  ({ data, id, selected, dragging }: NodeProps<Node<DodafOrganizationData>>) => {
    ...
    return (
      <>
        ...
        <div
          style={{
            ...dodafOrganizationnodeStyle(theme, data.style, !!selected, data.isHovered, data.faded),
          }}
